...
//初始化时间
Calender.prototype.renderDom = function(){
...
Calender.prototype.renderDayDom = function(tYear,tMonth){
...
//对日历的选择日绑定事件
Calender.prototype.bindDayDom = function(){
	var caption = this.caption;
	var thead = this.thead;
	var tbody = this.tbody;
	var self = this;
...
//对日历的选择月份绑定事件
Calender.prototype.bindMonthDom = function(){
	var caption = this.caption;
	var thead = this.thead;
	var tbody = this.tbody;
	var self = this;
...
//对日历的选择年绑定事件
Calender.prototype.bindYearDom = function(){
	var caption = this.caption;
	var thead = this.thead;
	var tbody = this.tbody;
	var self = this;
...
//缩放到月份日历
Calender.prototype.renderMonth = function(tYear){
	var caption = this.caption;
	var thead = this.thead;	
	var tbody = this.tbody;
	thead.innerHTML = '';
...
//缩放到年日历
Calender.prototype.renderYear = function(tYear){
	var caption = this.caption;
	var tbody = this.tbody;
